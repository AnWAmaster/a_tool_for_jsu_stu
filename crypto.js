...
function encryptByDES(message, key) {
    var keyHex = _this.CryptoJS.enc.Utf8.parse(key);
    var encrypted = _this.CryptoJS.DES.encrypt(message, keyHex, {
        mode: _this.CryptoJS.mode.ECB,
        padding: _this.CryptoJS.pad.Pkcs7,
    });
    return encrypted.ciphertext.toString();
}

function parse(originPwd) {
    let transferKey = "u2oh6Vu^HWe40fj";
    let pwd = encryptByDES(originPwd, transferKey);
    return pwd;
}